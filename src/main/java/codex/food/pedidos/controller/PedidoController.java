package codex.food.pedidos.controller;

import codex.food.pedidos.dto.PedidoDto;
import codex.food.pedidos.dto.StatusDto;
import codex.food.pedidos.service.PedidoService;
...
public class PedidoController {
        ...
        @PutMapping("/{id}/pago")
        public ResponseEntity<Void> aprovaPagamento(@PathVariable @NonNull Long id) {
